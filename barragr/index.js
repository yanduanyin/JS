let data = [
    {value:'66666，这操作骚啊',time:5,color:'red',speed:1,fontSize:22},
    {value:'技术活！该赏！！！',time:3},
    {value:'6666666666666666!!!!!',time:7},
...
class CanvasBarrage {
    ...
    constructor(canvas,video,opts={}){//opts={} 为了提高代码的容错性，如果没有传值，也不会报错
    ...
    renderBarrage() {
        ...
        this.barrages.forEach(barrage =>{
            ...
            if(!barrage.flag&&time>=barrage.time) {
                ...
                //弹幕从右往左渲染，所有x的坐标减去当前弹幕的speend
                barrage.x-=barrage.speed
                barrage.render()//渲染当前弹幕

                //如果当前弹幕x坐标比自身的宽度还小，就表示结束渲染
    ...
    add(obj){
        //实际上就是往barrages数组里添加一项Barrage实例
...
class Barrage {
    ...
    init() {
        ...
        this.y = this .context.canvas.height*Math.random();//位置随机出现
        // 做一下超出范围的处理
